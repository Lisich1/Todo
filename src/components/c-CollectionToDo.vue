<template>
    <li class="todos status" :class="listClass">
        ...
        <span class="span col s12"  v-if="list.isVisible" v-on:click="openList"
        >
          <div>
            {{list.title}}
          </div>
            <button class="btn waves-effect waves-light purple lighten-2" v-on:click="showRemovePopup" >&times;</button>
        </span>
    </li>
</template>
